...
import {User, SwitchButton, ShoppingCart, CirclePlus} from "@element-plus/icons-vue"   //图标
...
<!--TODO-->
<!--      这里图标显示是按照从左往右的，中间的空格是固定的，有点不适配，最好修改成从右往左-->
      <!--添加一个导向商店界面的图标-->
      <el-col :span="1" class="header-icon">
        <router-link to="/AllStores" v-slot="{navigate}">
